(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.SpellChecker = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
// const bs = require('binarysearch');
// const Levenshtien  = require('damerau-levenshtein');

// console.log(bs([1,4,7,9,22,100,1000],7) === 2)      // ===> Working with Browserify
// console.log(Levenshtien('hello world', 'Hello World!'))  // ===> Working with Browserify


// var Collator = new Intl.Collator(undefined, {'sensitivity': 'accent'});
// var res = bs.closest(
//     ['hello', 'world', 'super', 'good'], // Haystack
//     'good', // Needle
...
},{"binarysearch":30,"damerau-levenshtein":31}],2:[function(require,module,exports){
...
},{"./dictionary.js":1,"axios":3,"stripbom":32}],3:[function(require,module,exports){
